<template>
  <div>
    <v-card class="mx-auto">
      ...
      <div>
        <div class="ml-5">
          <h3 class="font-weight-thin" color="grey">Renda por mês</h3>
          <br />
          <br />
        </div>
      </div>
...
export default {
  ...
  computed: {
    ...mapGetters({
      months: "months",
      incomesByMonthChart: "incomesByMonthChart",
    }),
    me() {
      return this.$store.getters.me;
    },
    labels() {
      return this.$store.getters.incomesByMonthChart.labels;
    },
    values() {
      return this.$store.getters.incomesByMonthChart.values;
    },
    chartData() {
      return {
        labels: this.labels,
  ...
  methods: {
    ...mapActions(["getIncomesByMonthChartBar"]),
    ...
    getChartByMonth() {
      ...
      setTimeout(() => {
        ...
        this.getIncomesByMonthChartBar(params)
          .then((res) => {})
          .finally(() => {
